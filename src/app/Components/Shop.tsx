  ...
  return (
    <div className="p-4 sm:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Floating Phone</h1>
          <div className="flex items-center mb-2">
            <span className="text-yellow-500 text-lg mr-2">⭐</span>
            <span className="text-gray-600">10 Reviews</span>
          </div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">$1,139.33</h2>
      ...
      <div className="mt-12 border-t pt-6">
        <div className="flex gap-8 text-gray-600 mb-4 text-sm sm:text-base">
